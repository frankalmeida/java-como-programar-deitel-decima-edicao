...
public class CreditInquiry {
	...
	System.out.printf("%nEnter request%n%s%n%s%n%s%n%s%n", " 1 - List accounts with zero balances", " 2 - List accounts with credit balances", " 3 - List accounts with debit balances",
		" 4 - Terminate program");
	...
	try (Scanner input = new Scanner(Paths.get("C:\\Users\\Frank\\Desktop\\clientsJava.txt"))) {
